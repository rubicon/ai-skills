...
- `cache-money` skill v1.0.0 — 18 Claude Code token/context-management practices across three tiers (session hygiene, project-level hygiene, advanced cost control)
